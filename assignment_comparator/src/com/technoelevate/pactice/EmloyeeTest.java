...
public class EmloyeeTest {
	...
	public static void main(String[] args) {
		...
		arrayList.add(new Employee(20,"niha",24,56000));
		arrayList.add(new Employee(10,"niki",45,42000));
		arrayList.add(new Employee(15,"sam",28,120000));
		arrayList.add(new Employee(11,"jam",40,10000));
